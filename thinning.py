...
def rev_thinning_Hi(img):
	...
	thresh, src_b = cv.threshold(src_w, 0.5, 1.0, cv.THRESH_BINARY)

	thresh, src_f = cv.threshold(src_w, 0.5, 1.0, cv.THRESH_BINARY_INV)
	thresh, src_w = cv.threshold(src_w, 0.5, 1.0, cv.THRESH_BINARY_INV)
	...
	thresh, ret_img = cv.threshold(src_f, 0.5, 255.0, cv.THRESH_BINARY_INV)
